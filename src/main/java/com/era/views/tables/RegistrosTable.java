...
public class RegistrosTable extends BaseJTable {
   ...
   public void deleteObjectInTable(Object Model) throws Exception{
       ...
       RepositoryFactory.getInstance().getRegistrossRepository().delete(Model);
   ...
   public void insertNewObjectToTable(Object Model_) throws Exception {
       ...
       final Registros Registros = (Registros)Model_;

       RepositoryFactory.getInstance().getRegistrossRepository().save(Model_);
   ...
   public void deleteAllObjectsInTable() throws Exception {
       ...
       RepositoryFactory.getInstance().getRegistrossRepository().deleteAll();
