...
public class CxcTable extends BaseJTable {
   ...
   public void deleteObjectInTable(Object Model) throws Exception{
       ...
       RepositoryFactory.getInstance().getCxcsRepository().delete(Model);
   ...
   public void insertNewObjectToTable(Object Model_) throws Exception {
       ...
       final Cxc Cxc = (Cxc)Model_;

       RepositoryFactory.getInstance().getCxcsRepository().save(Model_);
   ...
   public void deleteAllObjectsInTable() throws Exception {
       ...
       RepositoryFactory.getInstance().getCxcsRepository().deleteAll();
