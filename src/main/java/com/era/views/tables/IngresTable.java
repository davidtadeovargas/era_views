...
public class IngresTable extends BaseJTable {
   ...
   public void initTable(List<?> items) {
       final IngresTableModel IngresTableModel = new IngresTableModel(this,items,this.ShowColumns);
   ...
   public void loadAllItemsInTable() throws Exception {
       ...
       final IngresTableModel IngresTableModel = new IngresTableModel(this,items_,this.ShowColumns);
       this.setModel(IngresTableModel);
   }
