...
public class TipsTableModel  extends BaseAbstractTableModel {
   ...
   public TipsTableModel(final JTable jTable, List<?> items, final List<ColumnTable> header){
       ...
       this.GetValueAt = (int rowIndex, int columnIndex, String valueColumn, final Object model) -> {
           ...
           else if(valueColumn.compareTo(TableHeaderFactory.getSigleton().getTipssTableHeader().getCODE().getValue())==0){
               returnValue = Tips.getCode();
           }
