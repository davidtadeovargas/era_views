...
public class ClasCli extends javax.swing.JFrame 
{
    ...
    public ClasCli() 
    {
        ...
        this.setTitle("Catálogo de clasificaciones clientes, Usuario: <" + Login.usuario + "> " + Login.sFLog);        
                    ...
                    else
                    {
                        ...
                        {                                                        
                            sQ = "UPDATE clasemp SET "
                                    ...
                                    + "WHERE cod        = '" + sCodOriG.replace("'", "''") + "' AND idempresa = '" + Login.codigo_empresa + "'";                                                
    ...
    private void vCargClas()
    {
        ...
        try
        {
            sQ = "SELECT cod, descrip FROM clasemp WHERE cod <> '-' AND idempresa = '" + Login.codigo_empresa + "' AND idempresa = '" + Login.codigo_empresa + "'";
            st = con.createStatement();
    ...
    private void jBDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBDelActionPerformed
        ...
        for(int x = iSel.length - 1; x >= 0; x--)
        {
            ...
            try
            {
                sQ = "SELECT codemp FROM emps WHERE codclas = '" + jTab.getValueAt(iSel[x], 1).toString().trim() + "' AND idempresa = '" + Login.codigo_empresa + "'";                        
                st = con.createStatement();
                rs = st.executeQuery(sQ);
            ...
            try 
            {                
                sQ = "DELETE FROM clasemp WHERE cod = '" + jTab.getValueAt(iSel[x], 1).toString() + "' AND idempresa = '" + Login.codigo_empresa + "'";                                            
                st = con.createStatement();
                st.executeUpdate(sQ);
             }
             catch(SQLException expnSQL) 
    ...
    private void jBNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBNewActionPerformed
        ...
        try
        {
            sQ = "SELECT descrip FROM clasemp WHERE descrip = '" + jTDescrip.getText() + "' AND idempresa = '" + Login.codigo_empresa + "'";
            st = con.createStatement();
            rs = st.executeQuery(sQ);
            /*Si hay datos*/
            if(rs.next())
        ...
        try 
        {            
            sQ = "INSERT INTO clasemp(cod,                                                                                              descrip,                                                        falt,       estac,                                      sucu,                                     nocaj,                                    idempresa) " + 
                        " VALUES('" + jTCod.getText().replace(" ", "").trim().replace("'", "''").replace(",", "") + "','" +             jTDescrip.getText().replace("'", "''").replace(",", "") + "',   now(), '" + Login.usuario.replace("'", "''") + "','" +    Star.sSucu.replace("'", "''") + "','" +   Star.sNoCaj.replace("'", "''") + "', '" + Login.codigo_empresa + "')";                                
            st = con.createStatement();
            st.executeUpdate(sQ);
         }
         catch(SQLException expnSQL) 
    ...
    private void jBBuscActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBBuscActionPerformed
        ...
        try
        {                  
            sQ = "SELECT * FROM clasemp WHERE cod LIKE('%" + jTBusc.getText().replace(" ", "%") + "%') OR descrip LIKE('%" + jTBusc.getText().replace(" ", "%") + "%') OR falt LIKE('%" + jTBusc.getText().replace(" ", "%") + "%') OR fmod LIKE('%" + jTBusc.getText().replace(" ", "%") + "%') AND idempresa = '" + Login.codigo_empresa + "'";
            st = con.createStatement();
            rs = st.executeQuery(sQ);
            /*Si hay datos*/
            while(rs.next())
