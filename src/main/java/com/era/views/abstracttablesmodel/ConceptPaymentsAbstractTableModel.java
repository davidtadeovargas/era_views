 ...
 * @author PC
 */
public class ConceptPaymentsAbstractTableModel extends AbstractTableModel {

    private List<Conceppag> deliveries;
    ...
    final public Conceppag getModel(int rowIndex){
        return this.deliveries.get(rowIndex);
    }
