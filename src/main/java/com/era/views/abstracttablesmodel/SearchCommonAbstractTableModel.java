...
public class SearchCommonAbstractTableModel extends BaseAbstractTableModel {
    ...
    public SearchCommonAbstractTableModel(List<?> deliveries, String[] header, final SearchCommonTypeEnum SearchCommonTypeEnum) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        String returnValue;
        if(IGetValueAt!=null){
            returnValue = IGetValueAt.getReturnValue(items.get(rowIndex), columnIndex);
        }
        else{
