...
public class CatMsjs extends javax.swing.JFrame 
{
    ...
    {                
        ...
        this.setTitle("Catálogo de mensajes, Usuario: <" + Login.usuario + "> " + Login.sFLog);        
    ...
    private void vCargM()
    {
        ...
        try
        {
            sQ = "SELECT msj FROM msjs WHERE id_id = " + jTab.getValueAt(jTab.getSelectedRow(), 3).toString() + " AND idempresa = '" + Login.codigo_empresa + "'";
    ...
    private void vCargMsj()
    {
        ...
        try
        {
            sQ = "SELECT id_id, estac, msj FROM msjs WHERE idempresa = '" + Login.codigo_empresa + "'";
            st = con.createStatement();
            rs = st.executeQuery(sQ);
    ...
    private void jBDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBDelActionPerformed
        ...
        for(int x = iSel.length - 1; x >= 0; x--)
        {
            ...
            try 
            {                
                sQ = "DELETE FROM msjs WHERE id_id = " + jTab.getValueAt(iSel[x], 3).toString() + " AND idempresa = '" + Login.codigo_empresa + "'";                                            
                st = con.createStatement();
                st.executeUpdate(sQ);
             }
             catch(SQLException expnSQL) 
    ...
    private void jBAgreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAgreActionPerformed
        ...
        try 
        {            
            sQ = "INSERT INTO msjs(estac,                                       msj,                                        falt,        sucu,                                        nocaj,                                    fmod,       idempresa) " + 
                      "VALUES('" + Login.usuario.replace("'", "''") + "','" +     jTAMsj.getText().replace("'", "''") + "',   now(),'" +   Star.sSucu.replace("'", "''") + "','" +      Star.sNoCaj.replace("'", "''") + "',      now(), '" + Login.codigo_empresa + "')";                                
            st = con.createStatement();
            st.executeUpdate(sQ);
         }
         catch(SQLException expnSQL) 
        ...
        try
        {
            sQ = "SELECT MAX(id_id) AS id_id FROM msjs WHERE idempresa = '" + Login.codigo_empresa + "'";
            st = con.createStatement();
            rs = st.executeQuery(sQ);
        ...
        DefaultTableModel te = (DefaultTableModel)jTab.getModel();
        Object nu[]= {iContFi, Login.usuario, jTAMsj.getText(), sId};
        te.addRow(nu);
    ...
    private void jBBuscActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBBuscActionPerformed
        ...
        try
        {                  
            sQ = "SELECT * FROM msjs WHERE msj LIKE('%" + jTBusc.getText().replace(" ", "%") + "%') OR estac LIKE('%" + jTBusc.getText().replace(" ", "%") + "%') OR falt LIKE('%" + jTBusc.getText().replace(" ", "%") + "%') OR fmod LIKE('%" + jTBusc.getText().replace(" ", "%") + "%') AND idempresa = '" + Login.codigo_empresa + "'";
            st = con.createStatement();
            rs = st.executeQuery(sQ);
            /*Si hay datos*/
            while(rs.next())
    ...
    private void jBGuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGuarActionPerformed
        ...
        {                
            sQ = "UPDATE msjs SET "
                    ...
                    + "WHERE id_id  = " + jTab.getValueAt(row, 3) + " AND idempresa = '" + Login.codigo_empresa + "'";                    
            st = con.createStatement();
            st.executeUpdate(sQ);
         }
         catch(SQLException expnSQL) 
