...
public class CFDIRelacionadosPagosTableHeader extends BaseTableHeader {
...
private final ColumnTable ROWNUMBER = new ColumnTable("No");
   ...
   private final ColumnTable TIPO_RELACION = new ColumnTable("TIPO_RELACION");
   public ColumnTable getTIPO_RELACION() {
       return this.TIPO_RELACION;
   }

   private final ColumnTable UUID = new ColumnTable("UUID");
   public ColumnTable getUUID() {
       return this.UUID;
   }
