 ...
 * @author PC
 */
public class DeliverAddressCustomerAbstractTableModel extends AbstractTableModel {

    private List<DeliverAddressCustomer> deliveries;
    ...
    final public DeliverAddressCustomer getModel(int rowIndex){
        return this.deliveries.get(rowIndex);
    }
