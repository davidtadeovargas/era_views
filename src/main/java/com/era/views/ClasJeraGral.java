...
public class ClasJeraGral extends javax.swing.JFrame 
{
    ...
    {                
        ...
        this.setTitle("Clasificaciones " + sTipC + " jerárquico, Usuario: <" + Login.usuario + "> " + Login.sFLog);        
    ...
    private void vCargNod()
    {
        ...
        try
        {
            sQ = "SELECT rut, clas FROM " + sTip + " WHERE idempresa = '" + Login.codigo_empresa + "'";
    ...
    private void jBDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBDelActionPerformed
        ...
        try
        {
            sQ = "SELECT clasjera FROM "+ sTip2 +" WHERE clasjera = '" + sRut + "' AND idempresa = '" + Login.codigo_empresa + "'";	
            st = con.createStatement();
            rs = st.executeQuery(sQ);
        ...
        try 
        {                
            sQ = "DELETE FROM "+ sTip+" WHERE rut LIKE('" + sRut + "%') AND idempresa = '" + Login.codigo_empresa + "'";                    
            st = con.createStatement();
            st.executeUpdate(sQ);
         }
         catch(SQLException expnSQL) 
    ...
    private void jBNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBNewActionPerformed
        ...
        try 
        {                
            sQ = "INSERT INTO "+ sTip +"(   clas,                                               rut,                                                                                            estac,                                       sucu,                                    nocaj,                                    idempresa) " + 
